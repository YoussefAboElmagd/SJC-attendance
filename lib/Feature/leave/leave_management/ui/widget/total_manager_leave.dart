...
import 'package:madarj/Feature/leave/leave_management/ui/widget/leave_manager_card.dart';
import 'package:madarj/generated/l10n.dart';

class TotalManagerLeave extends StatelessWidget {
  const TotalManagerLeave({super.key, this.timeoffBalanceData});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LeaveManagerCard(timeoffBalanceData: timeoffBalanceData),
                ],
              ),
            ),
          ),
