...
class AttendanceManagerTopHeader extends StatelessWidget {
  const AttendanceManagerTopHeader({super.key});
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    S.of(context).attendance_managment,
                    style: TextStyles.font22WhiteBold,
                  ),
                  Text(
                    S.of(context).attendance_requests,
