...
import 'package:madarj/Feature/base/ui_v2/widget/bottom_nav_bar_design_v2.dart';
...
class BottomNavigationBarItemButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //         if (cubit.currentIndex == 0) {
    //           final currentNavigatorState =
    //               cubit.navigatorKeysStudent[cubit.currentIndex].currentState;
    //           if (currentNavigatorState != null &&
    //               currentNavigatorState.canPop()) {
    //             currentNavigatorState.popUntil((route) => route.isFirst);
    //           }
    //         } else {
    //           cubit.emitChangeBottomNavStudent(0);
    //         }
    //       },
    //       child: BottomNavBarItemDesign(
    //         index: 0,
    ...
    //           }
    //         } else {
    //           cubit.emitChangeBottomNavStudent(1);
    //         }
    //       },
    //       child: BottomNavBarItemDesign(
    //         index: 1,
    ...
    //           }
    //         } else {
    //           cubit.emitChangeBottomNavStudent(2);
    //         }
    //       },
    //       child: BottomNavBarItemDesign(
    //         index: 2,
    ...
    //           }
    //         } else {
    //           cubit.emitChangeBottomNavStudent(3);
    //         }
    //       },
    //       child: BottomNavBarItemDesign(
    //         index: 3,
