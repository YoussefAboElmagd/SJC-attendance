...
import 'package:madarj/Feature/tasks/show_task/ui/widget/task_details_body.dart';
...
class ShowTaskDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Task Details', style: TextStyles.font18BlackSemiBold),
        centerTitle: true,
      ...
      body: BlocProvider(
        create: (_) => getIt<ShowTaskDetailsCubit>(),
